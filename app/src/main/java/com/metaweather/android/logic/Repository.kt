...
import com.metaweather.android.logic.dao.PlaceDao
import com.metaweather.android.logic.model.Place
import com.metaweather.android.logic.model.Weather
    ...
    fun refreshWeather(lng: String, lat: String) = fire(Dispatchers.IO) {
        coroutineScope {
            val deferredRealtime = async {
                MetaWeatherNetwork.getRealtimeWeather(lng, lat)
            }
            val deferredDaily = async {
                MetaWeatherNetwork.getDailyWeather(lng, lat)
            }
