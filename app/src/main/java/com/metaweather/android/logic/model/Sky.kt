...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("Cloudy", R.drawable.ic_partly_cloud_day, R.drawable.bg_partly_cloudy_day),
    "PARTLY_CLOUDY_NIGHT" to Sky("Partly cloudy", R.drawable.ic_partly_cloud_night, R.drawable.bg_partly_cloudy_night),
    ...
    "HEAVEY_HAZE" to Sky("Heavy haze", R.drawable.ic_heavy_haze, R.drawable.bg_fog),
